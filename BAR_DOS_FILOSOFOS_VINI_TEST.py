...
import logging
logging.basicConfig(filename='test3.csv',level=logging.DEBUG)
#logging.debug(',ID,SLEEP,WAIT,DRINK,QTE')
...
class filosofo(Thread):
    ...
    def run(self):
        while(self.drinks != self.k):
            ...
            logging.debug(','+str(self.iden)+','+str(t_calm)+','+str(t_sede)[6:]+','+str(self.drinks)+','+str(n))
